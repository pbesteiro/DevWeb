    ...
    <form id="form1" runat="server">
        ...
        <div class="parent">
                ...
                <div class="text-analytics">
                    <div>
                        <p class="div1-text1-sql">
                            El objetivo del curso es darte todos los conocimientos necesarios para que puedas afrontar
                        cualquier
                        desafío en esta tecnología. Para eso, realizaremos un proyecto basado en una pequeña red
                        social con
                        funciones básicas, implementando la separación de responsabilidades en capas, inyección de
                        dependencias,
                        ...
                        Trabajaremos con Programación Orientada a Objetos, Principios Solid y Patrones de Diseño.
                        Implementaremos
                        la seguridad con Json Web Tokens, y utilizaremos un cliente REST para probar nuestros servicios,
                        los cuales
                        se encontrarán securizados.
                        En todo el desarrollo se utilizarán buenas prácticas de implementación para la creación de
                        nuestra
                        aplicación Web API.
            ...
            <div class="div3">
                ...
                <p>
                    El curso está dirigido a estudiantes de los primeros años de la carrera de sistemas (siendo en
                universidad o
                ...
                <h3 class="title-general">Herramientas</h3>
                <ul>
            ...
            <div class="div4">
                ...
                online de
                2 horas cada uno + la preparación individual asincrónica de proyectos individuales y grupales.
                (Perprograming
                y mopprograming)
                </p>
